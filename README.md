...
- [protoc-gen-openapi](#protoc-gen-openapi)
  ...
  - [README.md in gnostic](#readmemd-in-gnostic)
    - [options](#options)

Contains a protoc plugin that generates openapi v3 documents. Forked from: 
- [github.com/google/gnostic/cmd/protoc-gen-openapi](https://github.com/google/gnostic/tree/main/cmd/protoc-gen-openapi)
- [github.com/kollalabs/protoc-gen-openapi](https://github.com/kollalabs/protoc-gen-openapi)

Installation:

    go install github.com/TeCHiScy/protoc-gen-openapi@latest
...
### Better Enum Support
Enums work better by using string values of proto enums, as well as custom `openapi.v3.desc`
tags instead of ints.
...
We added support for `protoc-gen-validate` annotations.
